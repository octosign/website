...
// TODO: Unify with the helpTemplate
// TODO: Add props type
const ResourcesTemplate: FC<{ data: any }> = ({ data, pathContext, path }) => {
  ...
  const allPages = edges
    .filter(
      e =>
        e.node.frontmatter.path.includes("/resources/") &&
            ...
            <article>
              <Breadcrumbs aria-label="breadcrumb">
                ...
                <Link
                  color="inherit"
                  href={
                    currentLanguage === "sk" ? "/sk/resources" : "/resources"
                  }
                >
